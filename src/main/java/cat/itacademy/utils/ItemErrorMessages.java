...
public class ItemErrorMessages {
        ...
        public static final String ITEM_NULL_OBJECT = "El objeto de decoración es nulo...";
        public static final String ITEM_DUPLICATED = "El objeto de decoración ya existe...";
